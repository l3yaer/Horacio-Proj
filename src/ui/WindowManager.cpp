...
WindowManager::WindowManager(int width, int height, const char *name) : Singleton<WindowManager>(), width(width), height(height)
{
    running = 1;
    ...
    SDL_Window *window = SDL_CreateWindow(name, SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, width, height,
                                          window_flags);
