...
std::string vector_vertex_shader_source = "#version 330 core\n"
	"layout (location = 0) in vec3 aPos;\n"
	"layout (location = 1) in vec2 aTexCoord;\n"
	"out vec2 TexCoord;\n"
	"out vec4 mColor;\n"
...
std::string vector_fragment_shader_source = "#version 330 core\n"
	"out vec4 FragColor;\n"
	"in vec2 TexCoord;\n"
	"in vec4 mColor;\n"
	"void main()\n"
...
std::map<std::string, ShaderPair> shaders = {
	...
	{ "vector", { vector_vertex_shader_source, vector_fragment_shader_source } },
